 ...
 * Uses only index metadata — never origin, provider_fqn, or vendor paths.
 */
export function scoreEndpointNeutral(ep) {
...
export function rankEndpointsNeutral(endpoints, max = 12) {
