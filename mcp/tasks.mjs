...
export const TASKS = [
  ...
  { q: "who registered the domain acme.com and where is it hosted", expect: "devtools.whois_lookup" },
  { q: "what city is the visitor on IP 8.8.8.8 in", expect: "devtools.ip_lookup" },
